...
Scenario: Create New Product
	...
	And I enter the product data in the field: NameProduct "Ketchup", UnitPrice "123", QuantityPerUnit "3-8", UnitInStock "6", UnitsOnOrder "2", ReorderLevel "10"
	And I select category "2" and supplier "1" in fields
	When I click on the CreateProduct-button
	Then I see product "Ketchup" in the table All Product